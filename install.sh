...
npm install -g tern prettier @asyncapi/generator @asyncapi/html-template @mermaid-js/mermaid-cli redocly bash-language-server yaml-language-server dockerfile-language-server-nodejs tree-sitter-cli
